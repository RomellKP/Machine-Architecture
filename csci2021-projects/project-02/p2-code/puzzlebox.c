...
void phase06(){
  ...
  int location1 = (hash % 211) % ilen; //18
  int location2 = (hash % 311) % ilen; //13
  ((int *)actual)[location1] = 0x58585858; //1482184792
  ((int *)actual)[location2] = 0x59595959; //1499027801
  *(((int *)actual) + a) = b;
  *(((int *)actual) + c) = d;
...
void phase08() {
 ...
 LEM1:
  ...
  goto LCHK;
 LAFT:
  return; //LCHK - LEM1 - LOC1 - LTOP - LCHK
}
